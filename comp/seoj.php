...
<div id="container" style="position:relative;margin:0 auto;padding:0;z-index:0;cursor:pointer;">
...
<script src="js/demo.js" ></script>
  ...
  <section class="main">
    ...
    <ul id="st-stack" class="st-stack-raw">
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>Welcome</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>How does it work?</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2># 1</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>What is SEO</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>100% safe for mother and child</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2># 2</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>97% of all babies are perfectly healthy</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>Baby's checkup</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>Here you can see the baby</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title"> <h2>Side effects of the 20 week ultrasound</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title"> <h2>solving together</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title"> <h2>soft markers</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title"> <h2>More than just an echo</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title"> <h2># 3</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>100% safe for mother and child</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2># 2</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>97% of all babies are perfectly healthy</h2></div></li>
      <li><div class="st-item"><img src="temp/images/a.jpg"/></a></div><div class="st-title">  <h2>Baby's checkup</h2></div></li>
