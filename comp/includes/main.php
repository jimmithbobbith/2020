 ...
 * Configure Idiorm
 */
$indexPage='http://www.twintigwekenecho.nl/index.php';
$db_host = 'wp.twintigwekenecho.nl';
$db_name = 'wpbm';
$db_user = 'asdpoi';
$db_pass = 'asdpoi';
...
$fromEmail =    'anne@broadbentmedical.com';
$anneEmail =    'anne@broadbentmedical.com';
$joeEmail =     'anne@broadbentmedical.com';
