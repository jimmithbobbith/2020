...
$grid->addColumn('rank', 'rank', 'integer');
$grid->addColumn('readall', 'readall', 'integer');
$grid->addColumn('registered', 'registered', 'date');
$grid->addColumn('last_login', 'last_login', 'date');
$grid->addColumn('token', 'token', 'string');
$grid->addColumn('token_validity', 'token_validity', 'date');
...
//$grid->addColumn('pgavg', 'pgavg', 'decimal_point');
$grid->addColumn('avatar', 'avatar', 'avatar');
