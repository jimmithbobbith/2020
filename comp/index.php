...
<form id="login-register" method="post" action="index.php">
    <br/> <br/>
    <h1>Inloggen Probleem</h1> <br/> <br/>
    <p id="suggestion"></p>
    <p>Helaas bent u niet ingelogd.
        <br/>Het beste kunt u de originele link gebruiken die u per email heeft ontvangen.  <br/>Als dit niet lukt stuurt u dan een email aan <a href="mailto:info@twintigwekenecho.nl?Subject=Inloggen%20Probleem" target="_top">info@twintigwekenecho.nl</a> dan nemen wij contact met u op..</p>
