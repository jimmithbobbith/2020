...
<label>type demo123</label><input type="password" name="password"><br />

<label>&nbsp;</label><input type="checkbox" name="autologin" value="1">Tick this and i will autologin even when you close the browseroony<br />
